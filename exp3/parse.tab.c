...
static const yytype_uint8 yyrline[] =
{
     ...
     114,   115,   116,   117,   118,   121,   122,   125,   132,   133,
...
static const char *const yytname[] =
{
  ...
  "IDN", "INT8", "INT10", "INT16", "REAL8", "REAL10", "REAL16", "'<'",
  "'>'", "'+'", "'-'", "'*'", "'/'", "';'", "'='", "'{'", "'}'", "'('",
  "')'", "$accept", "P", "L", "S", "SP", "C", "CP", "E", "T", "F", "LABEL", YY_NULLPTR
};
#endif
...
#line 101 "parse.y"
                        { (yyval.node) = create_ast_node(5, (yyvsp[-3].node), NULL, (yyvsp[0].node)); 
                          ...
                          if((yyvsp[0].node)->type==6)  backpatch((yyvsp[-3].node)->false_list, (yyvsp[0].node)->tac_line);}
...
#line 1674 "parse.tab.c"
  ...
  case 15:
#line 109 "parse.y"
                                    { (yyval.node) = create_ast_node(6, (yyvsp[-3].node), NULL, (yyvsp[0].node)); backpatch((yyvsp[0].node)->next_list,(yyvsp[-4].int_val)); backpatch((yyvsp[-3].node)->true_list,(yyvsp[-1].int_val)); (yyval.node)->next_list=merge((yyval.node)->next_list,(yyvsp[-3].node)->false_list); gen_tac(NULL,'9',NULL,NULL,(yyvsp[-4].int_val));}
